...
D3D12_SHADER_BYTECODE CIlluminatedShader::CreateVertexShader(ID3DBlob** ppd3dShaderBlob)
{
	...
	{
#ifdef _DEBUG
		dsb = &CShader::CompileShaderFromFile(L"Shaders.hlsl", "VSLighting", "vs_5_1", &m_pd3dVertexShaderBlob);
#else
		dsb = &CShader::ReadCompiledShaderFromFile(L"VSShaders.cso", &m_pd3dVertexShaderBlob);
#endif
	}
	return *dsb;
}
...
#else
	return(CShader::ReadCompiledShaderFromFile(L"PSShaders.cso", &m_pd3dPixelShaderBlob));
#endif
